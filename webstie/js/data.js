...
const RISO_CAL = {
  ...
  'Process Cyan': { hex:'#00aeef', gamma:1.0, grainMul:1.0, fluo:false, lut:[[0.85,0.94,0.96],[0.62,0.87,0.94],[0.38,0.78,0.92],[0.20,0.70,0.90],[0.00,0.60,0.88]] },
  'Process Magenta': { hex:'#ec008c', gamma:1.0, grainMul:1.0, fluo:false, lut:[[0.96,0.84,0.92],[0.95,0.60,0.82],[0.94,0.40,0.72],[0.93,0.24,0.62],[0.92,0.00,0.50]] },
  'Process Yellow': { hex:'#fff200', gamma:1.0, grainMul:0.2, fluo:false, lut:[[0.97,0.96,0.74],[0.97,0.95,0.50],[0.97,0.95,0.30],[0.97,0.94,0.14],[0.97,0.94,0.00]] },
  'Process Black': { hex:'#231f20', gamma:0.5, grainMul:1.5, fluo:false, lut:[[0.72,0.72,0.71],[0.55,0.55,0.54],[0.38,0.38,0.37],[0.25,0.25,0.24],[0.14,0.14,0.13]] },
};
const RISO_COLORS=[
