...
function bindSliders(){
  ['grainSize','dotGain','misreg','inkNoise','paperTex','lpi','grainStatic','ghosting','margin','skew','imgBright','imgContrast','imgSat','imgShadows','imgHighlights','ucrStr','balC','balM','balY','balK','tac','inkOpacity','layerDeplete','pressVar','densFlicker','ghostMul','postExposure','postContrast','postSat'].forEach(id=>{
